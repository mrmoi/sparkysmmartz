            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="{{ asset('images/coffeebeans.jpg') }}" alt="" style="width:100%;">
                        <div class="carousel-caption">
                            <div class="carouselCaption">Sparky's House Blend</div>
                        </div>
                    </div>
                    <div class="item">
                        <img src="{{ asset('images/coffeemug.jpg') }}" alt="" style="width:100%;">
                        <div class="carousel-caption">
                            <div class="carouselCaption">Sparky's Devil Espresso</div>
                        </div>
                    </div>
                    <div class="item">
                        <img src="{{ asset('images/coffeenumbers.jpg') }}" alt="" style="width:100%;">
                        <div class="carousel-caption">
